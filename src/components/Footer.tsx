...
const Footer = () => {
    return (
        <div className="py-24 px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-32 bg-gray-100 text-sm mt-24">
             {/*TOP*/}
            <div className="flex flex-col md:flex-row gap-24 justify-between">
                ...
                <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8" >
                    ...
                    <span className="font-semibold">+91 - 99996 93924</span>
                ...
                <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
                    ...
                    <div className="flex">
                        ...
                        <button type="button" className="w-1/4 bg-lama text-white">JOIN</button>
                    </div>

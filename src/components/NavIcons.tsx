        ...
        <div className="flex items-center gap-4 xl:gap-6 2xl:gap-8 relative">
            ...
            {isProfileOpen && (
                <div className="absolute p-4 rounded-md top-12 left-0 text-sm
                 z-40 shadow-[0_3px_10px_rgb(0,0,0,0.2)] bg-white">
                    <Link href="/profile">Profile</Link>
                    <div className="mt-2 cursor-pointer">Logout</div>
                </div>
            )}
            <div className="cursor-pointer relative">
                <Image src="/notification.png" alt="Notification" height={16} width={16} className="cursor-pointer"/>
                <div className="absolute -top-4 -right-4 w-6 h-6  bg-blue-400
            ...
            <div className="cursor-pointer relative">
                <Image src="/cart.png" alt="Cart" height={16} width={16} className=""
